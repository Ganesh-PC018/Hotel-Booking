...
const EditBookingPage = () => {
    ...
    useEffect(() => {
        const fetchBookingDetails = async () => {
            try {
                console.log(bookingConfirmationCode);
                const response = await ApiService.getByConfirmationCode(bookingConfirmationCode);
        ...
        <div className="find-booking-page">
            ...
            {bookingDetails && (
                <div className="booking-details">
                    <img src={bookingDetails.room.roomPhotoUrl} className='edit-booking-room-image' alt="" sizes="" srcSet="" />
